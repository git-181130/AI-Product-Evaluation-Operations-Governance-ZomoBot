...
End-to-end AI Product Evaluation, Operations, and Governance project demonstrating behavioral risk analysis, incident-driven ops, and evidence-based no-ship decisions.
...
- **Case Studies** — sanitized illustrations of real failure patterns  
- **Governance** — decision ownership, auditability, and re-entry criteria  
- **Portfolio Notes** — resume and interview mapping  

Each section includes its own `README.md` explaining intent and usage.
